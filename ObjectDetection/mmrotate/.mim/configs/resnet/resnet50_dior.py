...
model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='/share/home/dongzhe/Dongzhe/Foundation_Model/Downstream_Tasks/semantic_segmentation/pretrained/CMID_ResNet50_bk_200ep')),
    neck=dict(
        type='FPN',
